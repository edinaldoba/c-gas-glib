...
// Exportação e LaTeX (A força do seu trabalho acadêmico)
...
// Especializadas (Simulação FDTD/Maxwell)
void   mat_step_time( Matrix E, Matrix H, int i, int j ); // Sugestão para mat_step_time
